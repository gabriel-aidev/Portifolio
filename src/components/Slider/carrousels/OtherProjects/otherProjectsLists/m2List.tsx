...
export const m2Projects = [
  ...
  },
  {
    ...
    modalMsg:
      'Para executar a API localmente faça um clone do repositório e rode os comandos "npm install", "npm run start" e "npm run dev"',
    apiLink: 'https://github.com/Kenzie-Academy-Brasil-Developers/petInfo-API',
  },
  {
    description:
    ...
    modalMsg:
      'Infelizmente esta API era hospedada em servidor que encerrou a hospedagem gratuita. Estou em contato com os responsáveis. Por enquanto, a pagina está estática. O repositório do projeto continua disponível. Agradeço a compreensão.',
  },
  {
    description:
  ...
  },
  {
    ...
    modalMsg:
      'Para executar a API localmente faça um clone do repositório e rode os comandos "npm install" "npm run start" e "npm run dev"',
    apiLink: 'https://github.com/Kenzie-Academy-Brasil-Developers/kenzie-adopt',
  },
];
